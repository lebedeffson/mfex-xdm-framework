...
| Файл | Назначение |
|---|---|
| `XDM_Theory.ipynb` | Теория: что такое XDM, какие есть безмодельные методы и как они собираются в MFEX. |
| `XDM_Practice.ipynb` | Практика: выбор данных, запуск анализа, получение таблиц и отчёта. |
